...
|
*/
$host = $_SERVER['HTTP_HOST'];// localhost || test-example.com ||
...
if(is_cli()){
    ...
    $allowed = ['www.mng-sys.xyz', 'mng-sys.xyz'];
...
|
*/
$config['encryption_key'] = hex2bin('31016163f8b7f43caad37fe6812048da');
...
$config['sess_cookie_name'] = '_mng-sys__';
$config['sess_expiration'] = 7200;
$config['sess_save_path'] = BASEPATH.'sessions';//'mng-sys__sess';
