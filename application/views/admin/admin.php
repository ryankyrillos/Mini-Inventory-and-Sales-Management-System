                    ...
                    <div class="row">
                        ...
                        <div class="form-group-sm col-sm-6">
                            ...
                            <select class="form-control checkField" id='role'>
                                ...
                                <?php
                                if (empty($_SESSION['admin_id']) || (isset($_SESSION['admin_role']) && $_SESSION['admin_role'] === "Emplo") || (isset($_SESSION['admin_role']) && $_SESSION['admin_role'] === "Super")) {
                                ?>
                            ...
                            <?php } ?>
                            <?php
                                if (empty($_SESSION['admin_id']) || (isset($_SESSION['admin_role']) && $_SESSION['admin_role'] === "Emplo") || (isset($_SESSION['admin_role']) && $_SESSION['admin_role'] === "Owner")) {
                                ?>
                                <option value='Manager'>Manager</option>
                                <option value='Employee'>Employee</option>
                            </select>
